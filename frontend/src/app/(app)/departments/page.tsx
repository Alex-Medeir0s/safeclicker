              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs text-slate-400 bg-slate-100 px-2 py-1 rounded-full">ID {dept.id}</span>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-slate-100 text-slate-700 border border-slate-300 hover:bg-indigo-600 hover:border-indigo-600 hover:text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300"
                  >
                    ✏️ Editar
                  </button>
                  <button
                    onClick={() => handleDelete(dept.id)}
                    className="bg-slate-100 text-slate-700 border border-slate-300 hover:bg-red-600 hover:border-red-600 hover:text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300"
                  >
                    🗑️ Deletar
                  </button>
                </div>
